...
it('should get an initial access token', done => {
    const jwt = new src_1.JWT('foo@serviceaccount.com', PEM_PATH, undefined, ['http://bar', 'http://foo'], 'bar@subjectaccount.com');
...
it('can obtain new access token when scopes are set', () => __awaiter(this, void 0, void 0, function* () {
    const jwt = new src_1.JWT({
        email: 'foo@serviceaccount.com',
        keyFile: PEM_PATH,
        scopes: ['http://bar', 'http://foo'],
    ...
    const headers = yield jwt.getRequestHeaders();
    scope.done();
    assert.strictEqual(want, headers.Authorization, `the authorization header was wrong: ${headers.Authorization}`);
}));
it('gets a jwt header access token', () => __awaiter(this, void 0, void 0, function* () {
    ...
    const got = yield jwt.getRequestHeaders(testUri);
...
it('gets a jwt header access token with key id', () => __awaiter(this, void 0, void 0, function* () {
    const keys = keypair(1024 /* bitsize of private key */);
    const jwt = new src_1.JWT({
        email: 'foo@serviceaccount.com',
        key: keys.private,
...
it('should accept additionalClaims', () => __awaiter(this, void 0, void 0, function* () {
    const keys = keypair(1024 /* bitsize of private key */);
...
it('should accept additionalClaims that include a target_audience', () => __awaiter(this, void 0, void 0, function* () {
    const keys = keypair(1024 /* bitsize of private key */);
    const jwt = new src_1.JWT({
        email: 'foo@serviceaccount.com',
        key: keys.private,
...
it('should clear the cached refresh token promise after completion', () => __awaiter(this, void 0, void 0, function* () {
    ...
    yield jwt.request({ url: 'http://example.com' });
...
it('should return expiry_date in milliseconds', () => __awaiter(this, void 0, void 0, function* () {
    const jwt = new src_1.JWT({
        email: 'foo@serviceaccount.com',
        keyFile: PEM_PATH,
        scopes: ['http://bar', 'http://foo'],
    ...
    jwt.credentials.access_token = null;
    yield jwt.getRequestHeaders();
    scope.done();
    const dateInMillis = (new Date()).getTime();
    assert.strictEqual(dateInMillis.toString().length, jwt.credentials.expiry_date.toString().length);
}));
...
it('getCredentials should handle a key', () => __awaiter(this, void 0, void 0, function* () {
    const jwt = new src_1.JWT({ key: PEM_CONTENTS });
    const { private_key } = yield jwt.getCredentials();
    assert.strictEqual(private_key, PEM_CONTENTS);
}));
it('getCredentials should handle a p12 keyFile', () => __awaiter(this, void 0, void 0, function* () {
    const jwt = new src_1.JWT({ keyFile: P12_PATH });
    const { private_key, client_email } = yield jwt.getCredentials();
    assert(private_key);
    assert.strictEqual(client_email, undefined);
}));
it('getCredentials should handle a json keyFile', () => __awaiter(this, void 0, void 0, function* () {
    const jwt = new src_1.JWT();
    jwt.fromJSON(json);
    const { private_key, client_email } = yield jwt.getCredentials();
