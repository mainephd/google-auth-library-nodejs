...
it('should return null userId even if no payload', () => {
    const ticket = new loginticket_1.LoginTicket();
    assert.strictEqual(ticket.getUserId(), null);
});
it('should return envelope', () => {
    const ticket = new loginticket_1.LoginTicket('myenvelope');
...
it('should return attributes from getAttributes', () => {
    ...
    const ticket = new loginticket_1.LoginTicket('myenvelope', payload);
    assert.deepStrictEqual(ticket.getAttributes(), { envelope: 'myenvelope', payload });
});
