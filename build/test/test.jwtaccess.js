...
it('createScopedRequired should return false', () => {
    const client = new src_1.JWTAccess('foo@serviceaccount.com', null);
...
it('fromStream should construct a JWT Header instance from a stream', () => __awaiter(this, void 0, void 0, function* () {
    ...
    yield client.fromStream(stream);
